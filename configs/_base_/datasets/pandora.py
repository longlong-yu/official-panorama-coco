...
_metainfo = dict(classes=(
    ...
    'book', 'bottle', 'bowl', 'bucket', 'cabinet', 
    'chair', 'clock', 'clothes', 'computer', 'cup', 
    'cushion', 'door', 'extinguisher', 'fan', 'faucet', 
    'fireplace', 'heater', 'keyboard', 'light', 'microwave',
    'mirror', 'mouse', 'outlet', 'oven', 'paper extraction', 
    'person', 'phone', 'picture', 'potted plant', 'refrigerator', 
    'shoes', 'shower head', 'sink', 'sofa', 'table', 'toilet', 
    'towel', 'tv', 'vase', 'washer', 'window', 
    'wine glass'
))
_num_classes = 47
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        metainfo=_metainfo,
        data_root=data_root,
        ann_file='PANDORA/annotations/train.json',
